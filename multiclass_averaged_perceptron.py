...
def main():
    ...
    '''
    # Now for the average, let's train again but until best epoch
    averaged_perceptron = Perceptron(labels)
    ...
    for epoch in range(best_epoch+1):
        ...
        # Train
        averaged_perceptron.train(train_set)

    # Average perceptron
    averaged_perceptron.average_weights()
    print("\nAveraged weights: ")
    averaged_perceptron.print()
    '''
